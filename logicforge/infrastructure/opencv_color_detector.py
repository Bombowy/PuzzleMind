...
from logicforge.infrastructure.color_sampling_geometry import (
    CornerSampleGeometryError,
    corner_sample_bounds,
)
...
class OpenCvColorDetector(ColorDetector):
    ...
    def _sample_cells(
        ...
        for cell in grid.cells:
            try:
                bounds = corner_sample_bounds(cell, self._settings)
            except CornerSampleGeometryError as error:
